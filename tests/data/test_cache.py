...
@pytest.mark.asyncio
@patch("data.model_store.get_available_models", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("data.config_store.get_text_model_name", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("data.cache.get_db_connection")
@patch("data.user_settings.get_user_role", new_callable=AsyncMock)
@patch("data.user_settings.get_user_tts_settings", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("data.cache._warm_up_models_cache", new_callable=AsyncMock)
@patch("data.cache._warm_up_settings_cache", new_callable=AsyncMock)
@patch("data.cache._warm_up_users_cache", new_callable=AsyncMock)
